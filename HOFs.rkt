...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname HOFs) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
; [X] N [N -> X] -> [List-of X]
